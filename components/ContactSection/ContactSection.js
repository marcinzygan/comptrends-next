  ...
  return (
    <section id="contact">
      ...
      <div className={classes.contact__container}>
        ...
        <div className={classes.social__details_wrapper}>
          <div
          ...
          <p
            className={
              classes.contact__details_txt +
              " " +
              classes.contact__details_phone
            }
          >
            Telefon<span className="span__accentFirst"> : </span> +48 884 029
            659
          </p>
          <p
            className={
              classes.contact__details_txt +
              " " +
              classes.contact__details_email
            }
          >
